...
var AIMessage = class extends BaseMessage {
  ...
  constructor(fields, kwargs) {
    ...
    if (typeof fields === "string") {
      ...
      if (rawToolCalls !== void 0 && rawToolCalls.length > 0 && (toolCalls === void 0 || toolCalls.length === 0)) {
        console.warn([
      ...
      try {
        if (rawToolCalls !== void 0 && toolCalls === void 0) {
...
if (getEnvironmentVariable("LANGCHAIN_TRACING_V2") === "true" && getEnvironmentVariable("LANGCHAIN_CALLBACKS_BACKGROUND") !== "true") {
  console.warn([
...
@langchain/core/dist/utils/fast-json-patch/src/duplex.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EV5Y5HZE.js.map
