import {
  ...
  StuffDocumentsChain
} from "./chunk-66JZPSUV.js";
import {
  LLMChain
} from "./chunk-MIZVTCDC.js";
import {
  BaseChain
} from "./chunk-VR2S2ZJB.js";
import {
  AIMessagePromptTemplate,
  ChatPromptTemplate,
  HumanMessagePromptTemplate,
  SystemMessagePromptTemplate
} from "./chunk-R4VASNH7.js";
import {
  PromptTemplate
} from "./chunk-FNCJYJPD.js";
...
{context}`;
var messages2 = [
  SystemMessagePromptTemplate.fromTemplate(system_template2),
  HumanMessagePromptTemplate.fromTemplate("{question}")
];
var CHAT_QA_PROMPT = ChatPromptTemplate.fromMessages(messages2);
var COMBINE_QA_PROMPT_SELECTOR = new ConditionalPromptSelector(DEFAULT_COMBINE_QA_PROMPT, [
...
var COMBINE_PROMPT_SELECTOR = new ConditionalPromptSelector(COMBINE_PROMPT, [
...
var messages3 = [
  HumanMessagePromptTemplate.fromTemplate("{question}"),
  AIMessagePromptTemplate.fromTemplate("{existing_answer}"),
  HumanMessagePromptTemplate.fromTemplate(refineTemplate)
];
var CHAT_REFINE_PROMPT = ChatPromptTemplate.fromMessages(messages3);
var REFINE_PROMPT_SELECTOR = new ConditionalPromptSelector(DEFAULT_REFINE_PROMPT, [
...
var chat_messages = [
  SystemMessagePromptTemplate.fromTemplate(chat_qa_prompt_template),
  HumanMessagePromptTemplate.fromTemplate("{question}")
];
var CHAT_QUESTION_PROMPT = ChatPromptTemplate.fromMessages(chat_messages);
var QUESTION_PROMPT_SELECTOR = new ConditionalPromptSelector(DEFAULT_TEXT_QA_PROMPT, [
  [isChatModel, CHAT_QUESTION_PROMPT]
]);

// node_modules/langchain/dist/chains/question_answering/load.js
var loadQAChain = (llm, params = { type: "stuff" }) => {
  const { type } = params;
  if (type === "stuff") {
...
//# sourceMappingURL=chunk-2IG6YIPA.js.map
