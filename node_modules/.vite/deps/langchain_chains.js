...
import {
  APIChain
} from "./chunk-4MWW7JGH.js";
import {
  ChatOpenAI,
  OpenAI
} from "./chunk-E76UE6CV.js";
import {
  BufferMemory
} from "./chunk-3HSS6SRQ.js";
import {
  LLMChain
...
import "./chunk-VCJFKR62.js";
import "./chunk-Z543M2NB.js";
import {
  ChatPromptTemplate,
...
import "./chunk-TXWCRTUP.js";
import {
  BaseDocumentTransformer
} from "./chunk-6SB7X2WS.js";
import {
  Document
} from "./chunk-7PTX5PF7.js";
import "./chunk-5U4X5J7M.js";
import {
  AIMessage,
  AsyncCaller,
  HumanMessage,
    ...
    if ("type" in schema2) {
      ...
      if (schema2.type === "object" && schema2.properties) {
        ...
        const properties = Object.entries(schema2.properties).map(([key, value]) => {
          var _a;
          const isOptional = ((_a = schema2.required) == null ? void 0 : _a.includes(key)) ? "" : " (optional)";
...
var OpenAPISpec = class _OpenAPISpec {
  ...
  getParametersStrict() {
    var _a;
    if (!((_a = this.document.components) == null ? void 0 : _a.parameters)) {
  ...
  getSchemasStrict() {
    var _a;
    if (!((_a = this.document.components) == null ? void 0 : _a.schemas)) {
  ...
  getRequestBodiesStrict() {
    var _a;
    if (!((_a = this.document.components) == null ? void 0 : _a.requestBodies)) {
